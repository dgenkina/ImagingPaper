...
%                                                                      %
%    modified by Mitsuaki Funakoshi                                    %
%          (editor-in-chief of Fluid Dynamics Reserarch)               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
\vspace{2pc}
\noindent{\it Keywords}: Article preparation, Fluid dynamics, Turbulence
...
of the \verb"graphicx" package, refer to one of the books on \LaTeX\ (Goosens \etal 1997) 
